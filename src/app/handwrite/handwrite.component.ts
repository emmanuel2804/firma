...
export class HandwriteComponent implements OnInit, AfterViewInit {
  @ViewChild('sPad', { static: true }) signaturePadElement;
  signaturePad: any;
  parent_width = document.getElementById('container').offsetWidth;
  constructor() {}
  ...
  ngAfterViewInit(): void {
    ...
    // this.parent_width = document.getElementById('container').offsetWidth;
  }
